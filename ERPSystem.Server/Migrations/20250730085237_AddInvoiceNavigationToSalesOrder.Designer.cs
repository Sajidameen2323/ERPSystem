...
namespace ERPSystem.Server.Migrations
{
    ...
    [Migration("20250730085237_AddInvoiceNavigationToSalesOrder")]
    partial class AddInvoiceNavigationToSalesOrder
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ERPSystem.Server.Models.InvoiceItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ERPSystem.Server.Models.StockReservation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ERPSystem.Server.Models.Invoice", b =>
                {
                    ...
                    b.HasOne("ERPSystem.Server.Models.SalesOrder", "SalesOrder")
                        .WithOne("Invoice")
                        .HasForeignKey("ERPSystem.Server.Models.Invoice", "SalesOrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ERPSystem.Server.Models.InvoiceItem", b =>
                {
                    b.HasOne("ERPSystem.Server.Models.Invoice", "Invoice")
